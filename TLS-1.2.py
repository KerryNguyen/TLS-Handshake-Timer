import os, ssl, socket, warnings, time, pyfiglet

os.system('cls')

print(pyfiglet.figlet_format("TLS-1.2", font="smblock"))
...
# openssl s_server -accept 6768 -cert cert.pem -key key.pem -min_protocol TLSv1.2 -cipher "ALL:@SECLEVEL=0
# raw_sock = socket.create_connection(("localhost", port))

# Setting up the settings for the client
# We're setting it to ONLY use TLS 1.2
